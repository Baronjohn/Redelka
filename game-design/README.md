...
This folder holds game design documents for **Redelka**.
...
| [prototype.md](prototype.md) | Phase 1 combat greybox (functional at core) and Phase 2 exploration handoff |
...
- **Decided** — locked from design Q&A; treat as authoritative unless revised.
- **TBD** — intentionally open; do not assume values in implementation.

Keep filenames lowercase with hyphens. Add new docs here as the project grows.
