...
func _ready() -> void:
	...
	SfxManager.wire_menu_button(move_button)
	SfxManager.wire_menu_button(action_button)
	SfxManager.wire_menu_button(wait_button, true)
	SfxManager.wire_menu_button($CommandPanel/Margin/VBox/CommandBar/ActionMenu/AttackButton)
	SfxManager.wire_menu_button($CommandPanel/Margin/VBox/CommandBar/ActionMenu/SpellButton)
	SfxManager.wire_menu_button($CommandPanel/Margin/VBox/CommandBar/ActionMenu/SkillButton)
	SfxManager.wire_menu_button($CommandPanel/Margin/VBox/CommandBar/ActionMenu/ItemButton)
	SfxManager.wire_menu_button($CommandPanel/Margin/VBox/CommandBar/ActionMenu/SwitchButton)
	SfxManager.wire_menu_button($CommandPanel/Margin/VBox/CommandBar/ActionMenu/RetreatButton)
	SfxManager.wire_menu_button(back_button)
	SfxManager.wire_item_list(spell_menu)
	SfxManager.wire_item_list(item_menu)
	SfxManager.wire_item_list(weapon_menu)
	hide_menus()
